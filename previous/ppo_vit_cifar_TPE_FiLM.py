...
sweep_config = {
    ...
    'parameters': {
        ...
        'entropy_coef':  {'min': 1e-4,  'max': 1e-1},
        'batch_size':    {'values': [32, 64, 128]},
        'update_epochs': {'values': [2, 4, 8]},
        'rollout_length':{'values': [64, 128, 256, 512]},
        'clip_epsilon':  {'min': 0.1,   'max': 0.3},
        'gamma':         {'min': 0.9,   'max': 0.999},
        'gae_lambda':    {'min': 0.8,   'max': 0.99},
        'correct_bonus': {'min': 0.5,   'max': 5.0},
        'wrong_penalty': {'min': 0.5,   'max': 5.0},
        'zoom_bonus':    {'min': 0.0,   'max': 1.0},
        'move_penalty':  {'min': 0.0,   'max': 1.0},
    }
}
